<template>
  <el-form
    ...
    :model="invoiceStore.invoicePaymentForm"
    :rules="rules"
    ...
    <div class="flex gap-x-2 mb-2">
      <div class="flex h-fit">
        <el-form-item prop="currency">
          <MazSelect
            disabled
            v-model="invoiceStore.invoicePaymentForm.currency"
      ...
      <div class="flex-1">
        <el-form-item prop="amount">
          <MazInput
            ...
            key="lg"
            color="warning"
            v-model="invoiceStore.invoicePaymentForm.amount"
            label="Enter Amount"
            size="md" />
        </el-form-item>
      </div>
    ...
    <el-form-item prop="reference">
      ...
      <MazInput
        ...
        key="lg"
        color="warning"
        v-model="invoiceStore.invoicePaymentForm.reference"
        label="Reference"
    ...
    <PaymentMethod
      ...
      v-model="invoiceStore.SelectedPaymentOption"
      class="flex-1" />
      ...
      <div class="flex flex-col justify-center items-center">
        ...
        <div class="w-full border border-gray-200 p-5 mt-5 rounded-md">
          <p class="text-lg">
            ...
            <span class="font-semibold">Monthly Invoice for Coporate Car Wash</span>'s
            Invoice
...
const { isPaymentMethodSelected, isOTPSuccessfull, invoicePaymentForm } =
