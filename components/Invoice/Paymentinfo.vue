    ...
    <div class="flex flex-col w-full bg-white lg:p-5 md:p-10 p-5">
        ...
        <div class="flex flex-col">
            ...
            <div class="flex justify-between items-center mb-2">
                ...
                <div class="flex justify-center">
                    <button type="button" @click="toggleInvoiceItems"
                        class="  flex  gap-x-2 items-center border border-gray-300 w-fit px-2 py-1 rounded-full">
                        <Icon v-if="showInvoiceItems" class="text-teal-950" name="ic:twotone-keyboard-arrow-up" />
            ...
            <div class="flex flex-col my-4 gap-y-2">
                ...
                <div class="flex gap-x-2  justify-start">
                    ...
                    <h2 class="text-sm">{{ formateDate(invoice?.due_date!, 'Mo MMM YYYY h:ss a') }}</h2>

                </div>
            </div>

            <!-- items -->
            <div v-if="showInvoiceItems" v-for=" (item, index) in invoice?.invoice_items" :key="index"
        ...
        <div class="flex flex-col gap-y-2">
            ...
            <div class="flex  justify-between">
                ...
                <h2 class="text-sm">{{ invoice?.currency }} {{ invoice?.amount_after_discount }}</h2>
            </div>
            ...
            <div v-for="(tax, index) in invoice?.taxes" :key="index" class="flex  justify-between">
